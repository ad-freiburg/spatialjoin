...
WKTParserBase<ParseJobT>::WKTParserBase(sj::Sweeper *sweeper, size_t numThreads)
...
// _____________________________________________________________________________
template <typename ParseJobT> WKTParserBase<ParseJobT>::~WKTParserBase() {
...
// _____________________________________________________________________________
template <typename ParseJobT> void WKTParserBase<ParseJobT>::done() {
  if (_curBatch.size()) {
...
// _____________________________________________________________________________
template <typename ParseJobT>
void WKTParserBase<ParseJobT>::parseLine(char *c, size_t len, size_t gid,
                                         size_t t, sj::WriteBatch &batch,
                                         bool side) {
...
// _____________________________________________________________________________
template <typename ParseJobT>
void WKTParserBase<ParseJobT>::processQueue(size_t t) {
  ParseBatch batch;
